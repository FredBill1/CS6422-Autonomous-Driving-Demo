...
#endif // QT_CONFIG(shortcut)
        self.cancel_button.setText(QCoreApplication.translate("MainWindow", u"Cancel(D)", None))
#if QT_CONFIG(shortcut)
        self.cancel_button.setShortcut(QCoreApplication.translate("MainWindow", u"D", None))
#endif // QT_CONFIG(shortcut)
        self.restart_button.setText(QCoreApplication.translate("MainWindow", u"Restart(F)", None))
#if QT_CONFIG(shortcut)
        self.restart_button.setShortcut(QCoreApplication.translate("MainWindow", u"F", None))
#endif // QT_CONFIG(shortcut)
    # retranslateUi
