...
DELTA_TIME = 0.1
SIMULATION_DELTA_TIME = 0.2
CANVAS_ANIMATION_INTERVAL = 200
DASHBOARD_ANIMATION_INTERVAL = 200
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self._visualization_ax.plot(*self._obstacles.coordinates.T, ".r")
        ...
        self._car_simulation_node = CarSimulationNode(
            ...
            simulation_delta_time_s=SIMULATION_DELTA_TIME,
        )
        ...
        self.canceled.connect(self._car_simulation_node.cancel)
        ...
        self._global_planner_node.display_segments.connect(self._update_global_planner_nodes)
        ...
        self._local_planner_node.moveToThread(self._car_simulation_thread)
        self._global_planner_node.trajectory.connect(self._local_planner_node.set_trajectory)
        self._car_simulation_node.measured_state.connect(
            self._local_planner_node.update, Qt.ConnectionType.DirectConnection
        )
        self._local_planner_node.control.connect(
            self._car_simulation_node.set_control, Qt.ConnectionType.DirectConnection
        )
    ...
    def _update_visualization_ax(self, *_) -> None:
    ...
    @Slot(LineCollection)
    def _update_global_planner_nodes(self, display_segments: LineCollection) -> None:
